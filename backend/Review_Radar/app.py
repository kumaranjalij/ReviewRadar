...
# Define base directory for loading models and vectorizers
base_dir = os.path.dirname(os.path.abspath(__file__))

# Load models and vectorizer
try:
    Apple_nmf_model = pickle.load(open(os.path.join(base_dir, "Apple_model.pkl"), "rb"))
    Apple_vectorizer = pickle.load(open(os.path.join(base_dir, "Apple_vectorizer.pkl"), "rb"))
    Samsung_nmf_model = pickle.load(open(os.path.join(base_dir, "Samsung_model.pkl"), "rb"))
    Samsung_vectorizer = pickle.load(open(os.path.join(base_dir, "Samsung_vectorizer.pkl"), "rb"))
...
def company_home(company_name):
    ...
    if company_name.lower() == "apple":
        # Data for Apple
        with open(os.path.join(base_dir, "images/Apple1.png"), "rb") as file:
            image1_data = base64.b64encode(file.read()).decode('utf-8')
        with open(os.path.join(base_dir, "images/Apple2.png"), "rb") as file:
        ...
        # Data for Samsung
        with open(os.path.join(base_dir, "images/Samsung1.png"), "rb") as file:
            image1_data = base64.b64encode(file.read()).decode('utf-8')
        with open(os.path.join(base_dir, "images/Samsung2.png"), "rb") as file:
            image2_data = base64.b64encode(file.read()).decode('utf-8')
        data = {
            "company": "Samsung",
            "images": [image1_data, image2_data],
...
def analyze_review(company_name):
    ...
    logging.info("Sentiment analyzed for company %s", company_name)
