...
additional_stopwords = ['phone', 'samsung', 'galaxy']
...
with open("Samsung_model.pkl", "wb") as model_file:
    pickle.dump(nmf_model, model_file)

with open("Samsung_vectorizer.pkl", "wb") as vectorizer_file:
    pickle.dump(vectorizer, vectorizer_file)

# Save the TF-IDF matrix to a file using pickle
with open("Samsung_tfidf_matrix.pkl", "wb") as f:
    pickle.dump(tfidf_matrix, f)

# Save the preprocessed sentences to a file using pickle
with open("Samsung_preprocessed_sentences.pkl", "wb") as f:
